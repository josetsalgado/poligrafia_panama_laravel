...
@section('content')
                            ...
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td>  
                                        ...
                                        <button class="btn btn-danger btn-xs" id="delete" name="delete" value="{{ $service->id_service }}" onclick="fnDelete({{ $service->id_service }})" data-toggle="tooltip" data-placement="right">
    ...
    <script src="public/js/validate/fn-updateService.js"></script>
