...
@section('content')
                        ...
                        <form class="form-horizontal form-label-left">
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="false">Prueba 1</a>
                                    </li>
                                    <li role="presentation" class=""><a href="" role="tab" id="profiletab2" data-toggle="tab" aria-expanded="true"><i class="fa fa-plus"></i></a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                <select id="pais" class="form-control selc-empresa" required>
                                                    ...
                                                    <option value="prueba-permanencia">Prueba Especifica</option>
                                                    <option value="prueba-especifica">Prueba Rutina</option>
                                                    <option value="pruebas-psicologicas">Reevaluación   </option>
                                                </select>
    ...
    <script type="text/javascript">
        ...
        var contador = 0;
        $("#profiletab2").click(function(){
            var cont = contador+1;
            tabPrueba(cont);
            $(this).remove();
        });

        function tabPrueba(contador) {
            var cont = contador++;
            var btn = "#" + cont;
            $(btn).remove();
            $("#myTab").append('<li role="presentation" class=""><a href="#tab_content'+contador+'" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Prueba '+contador+'</a></li><li role="presentation" class=""><a href="" id="'+contador+'"  onclick="tabPrueba(this.id)"  role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-plus"></i></a></li>');
        }
